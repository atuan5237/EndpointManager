...
======================================================================================================
 ...
 Created by:    atuan5237
 Version:       0.1  
 Function:      Configure Lenovo BIOS with dynamic config on Github
 Reference from: https://github.com/mmelkersen/EndpointManager/tree/main/BIOS
...
[string]$GithubConf = "https://raw.githubusercontent.com/atuan5237/EndpointManager/main/BiosConfiguration.csv"
